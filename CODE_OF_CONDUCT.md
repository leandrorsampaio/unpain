...
project maintainer privately — by opening a report through the repository's **Security** tab, or
by contacting the maintainer through their GitHub profile. All complaints will be reviewed and
investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the reporter of any
incident.

> Maintainer note: this is a small project shared as-is; there is no dedicated moderation team.
> Replace this section with a preferred private contact (e.g. an email) if you set one up.
