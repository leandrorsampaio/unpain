...
for t in tests/test_pipeline.py tests/test_oracle.py tests/test_feedback.py \
         ...
         tests/test_money.py tests/test_schemas.py tests/test_doctor_audit.py tests/test_format_lint.py tests/test_fx_audit.py tests/test_anomalies.py tests/test_audit_changes.py tests/test_export_provenance.py \
